...
abstract class $CategoryStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CategoryModel> categoryList, CategoryModel category});
...
class _$_CategoryState extends _CategoryState {
  _$_CategoryState(
      {required final List<CategoryModel> categoryList, required this.category})
  ...
  @override
  String toString() {
    return 'CategoryState(categoryList: $categoryList, category: $category)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_categoryList), category);
...
abstract class _CategoryState extends CategoryState {
  factory _CategoryState(
      ...
      required final CategoryModel category}) = _$_CategoryState;
